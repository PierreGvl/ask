              ...
              <span className="flex flex-col gap-0.5">
                {c.url ? (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-navy-700 hover:text-rose hover:underline"
                  >
                    {isWeb && <Globe className="h-3.5 w-3.5 shrink-0" />}
                    {label}
                  </a>
                ) : (
